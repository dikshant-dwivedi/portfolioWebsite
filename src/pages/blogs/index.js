          ...
          <OverLay>
            <CardContainer>
              ...
              >
                ...
                <Body>
                  <Title>
                    Weighted union and find operations in disjoint subsets data
                    structure
                  </Title>
                  <Description>
                    For the implementation of Kruskal’s algorithm, a minimum
                    spanning tree is built adding one edge at a time. Along the
                    way, we need to keep track of the connected components and
                    also detect cycles. For achieving this, it is essential to
                    understand disjoint set data structure and its find-union
                    operation.
                  </Description>
                </Body>
                <Tags>
              ...
              >
                ...
                <Body>
                  <Title>
                    Lesson learnt the hard way: how projects helped me learn web
                    development.
                  </Title>
                  <Description>
                    One of the earliest realizations I’ve had is how important
                    it is to stay open to learn a diverse set of technologies in
                    order to be relevant in the industry. With that being said,
                    what is the best way to learn a technology? Here’s my take
                    on it.
                  </Description>
                </Body>
                <Tags>
              ...
              >
                ...
                <Body>
                  ...
                  <Description>
                    ...
                    the end of the array is reached. This approach in worst case
                    scenario can lead to traversal of the whole array. Given a
                    sorted array, we can improve the efficiency of our search
                    operation by performing binary search algorithm on it. Let’s
                    start by observing the property of a sorted array that makes
                    it suitable for binary search.
                  </Description>
                </Body>
                <Tags>
                  <Tag>Data Structures and Algorithms</Tag>
